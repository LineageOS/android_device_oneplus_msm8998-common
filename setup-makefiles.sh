...
\$(shell mkdir -p \$(TARGET_COPY_OUT_VENDOR)/lib/egl && pushd \$(TARGET_COPY_OUT_VENDOR)/lib > /dev/null && ln -sf egl/libEGL_adreno.so libEGL_adreno.so && popd > /dev/null)
\$(shell mkdir -p \$(TARGET_COPY_OUT_VENDOR)/lib64/egl && pushd \$(TARGET_COPY_OUT_VENDOR)/lib64 > /dev/null && ln -sf egl/libEGL_adreno.so libEGL_adreno.so && popd > /dev/null)
EOF
